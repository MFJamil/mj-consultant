<template>
    <header class="top-0 z-40 block sticky backdrop-saturate-100 backdrop-blur-xl w-full max-w-full"
    ...
    <nav class="text-black block">
      ...
      >
        ...
        <!--  Menu Button-->
        <button @click="showMenu=!showMenu" :style="`color:rgb(${tc},${tc},${tc})`" 
        ...
        <div class="backdrop-saturate-100 backdrop-blur-xl relative w-full md:hidden sm:block sm:w-auto" 
